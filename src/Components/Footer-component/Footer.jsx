      ...
      <footer className="pa4 pa5-l black-70 bt b--black-10">
        ...
        <div className="mb4-l cf">
          <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns">
            ...
            <span className="color f7 f6-l db black-70">837 Larkin St.</span>
            <span className="color f7 f6-l black-70">
              San Francisco, CA 94109{" "}
            </span>
            <a
              className="color f6 db fw6 pv3 black-70 link dim"
              title="Call SF"
          ...
          <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pl2 pl0-ns">
            <h4 className="color f5 f4-l fw6">LA</h4>
            <span className="color f7 f6-l db black-70">1111 Manor Way</span>
            <span className="color f7 f6-l di black-70">
              Los Angeles, CA 90048
            </span>
            <a
              href="tel:+13235555555"
              className="color f6 db fw6 pv3 link dim black-70"
          ...
          <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns">
            <h4 className="color f5 f4-l fw6">London</h4>
            <span className="color f7 f6-l db black-70">11 Downey St.</span>
            <span className="color f7 f6-l black-70">London, UK</span>
            <a
              href="tel:+5555555555"
              className="color link dim f6 db fw6 pv3 black-70"
          ...
          <article className="fl w-50 dib-ns w-auto-ns mb4 pl2 pl0-ns">
            <h4 className="color f5 f4-l fw6">Tokyo</h4>
            <span className="color f7 f6-l db black-70">1982 Flangan Rd.</span>
            <span className="color f7 f6-l">Shinjuku, Tokyo</span>
            <a
              href="tel:+444444444444"
              className="color f6 db dim fw6 pv3 link black-70"
        ...
        <div className="color dt dt--fixed w-100">
          <div className="color dn dtc-ns v-mid">
            <p className="color f7 black-70 dib pr3 mb3">
              Copyright © Your Company 2048
            </p>
          </div>
          <div className="color db dtc-ns black-70 tc tr-ns v-mid">
            <a
              href="https://www.facebook.com/"
              className="color link dim dib mr3 black-70"
            ...
            <a
              ...
              className="color link dim dib black-70"
            >
        ...
        <div className="color db dn-ns">
          <p className="color f7 black-70 mt4 tc">
